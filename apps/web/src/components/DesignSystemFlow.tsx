...
function buildCreationAgentPrompt(
  ...
  return [
    ...
    '- Build `ui_kits/app/` as an applied interface kit with `index.html`, a short README, and modular component files when the evidence includes representative product surfaces. For app/workspace evidence, include at least 3 reusable files under `ui_kits/app/components/` such as shell, sidebar, list, message, input, toolbar, or card components.',
...
function buildSourceContextManifest(
  ...
  sections.push(
    ...
    '- ui_kits/app/ should contain an applied interface example, plus at least 3 reusable files under `ui_kits/app/components/` when the source snapshots include representative app shells, navigation, chat/input surfaces, or reusable components.',
